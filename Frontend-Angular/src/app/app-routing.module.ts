...
const routes: Routes = [
  ...
  { path: 'items', loadChildren: () => import('./features/item/item.module').then(m => m.ItemModule), canActivate: [AuthGuard],canLoad: [AuthGuard] },
  { path: 'items/:search', loadChildren: () => import('./features/item/item.module').then(m => m.ItemModule), canActivate: [AuthGuard],canLoad: [AuthGuard] },
  { path: 'customers/:search', loadChildren: () => import('./features/customers/customers.module').then(m => m.CustomersModule), canActivate: [AuthGuard],canLoad: [AuthGuard]},
  { path: 'invoices/:search', loadChildren: () => import('./features/invoices/invoices.module').then(m => m.InvoicesModule), canActivate: [AuthGuard],canLoad: [AuthGuard]},
];
